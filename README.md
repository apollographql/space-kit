...
To get around this issue, add the following element where you want the emotion styles to be injected. If you don't include this, emotion's default behavior will be followed.
