...
storiesOf("Loaders", module)
  ...
  .add("Catalog", () => (
    <ClassNames>
      {({ css, cx }) => (
        <div className={cx(css({ color: colors.black.base }))}>
          <DemoSection
            title="Spinners"
          ...
          >
            ...
            >
              ...
              >
                {SPINNER_SIZES.map(size => (
                  <div key={size} className={cx(css({ margin: 20 }))}>
                    <span
                      className={cx(
                        css({
                    ...
                    <LoadingSpinner
                      className={cx(css({ display: "block" }))}
                      size={size}
                    />
                  </div>
                ))}
            ...
            >
              ...
              <Button
                ...
                className={cx(css({ width: "100%", marginBottom: 20 }))}
              >
                Submit
              </Button>
              <Button
